...
class Roster{
   ...
   //mutators 
      ...
      void deleteStudent(string studentid);//delete Student by searching via ID

      bool searchStudent(const Student& lilNasX);//searchStudent
      int searchStudent(string studentid);//overloaded searchStudent function
      ...
      void outputCourse();//output only the course information, not the # of students.
      void outputAll();//output all students in a roster
